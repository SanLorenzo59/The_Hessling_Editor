...
static char RCSid[] = "$Id: scroll.c,v 1.5 2003/02/08 03:26:47 mark Exp $";
...
/***********************************************************************/
{
   ...
   chtype color_filearea = set_colour( CURRENT_FILE->attr+ATTR_FILEAREA );
   chtype color_cursorline = set_colour( CURRENT_FILE->attr+ATTR_CURSORLINE );

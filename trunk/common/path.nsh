...
;    ReadRegStr $1 HKCU "Environment" "PATH"
    registry::Read "HKEY_CURRENT_USER\Environment" "PATH" .R0 .R1 .R2 .R3
    Goto AddToPath_UserCont
  AddToPath_AllUsers:
;    ReadRegStr $1 HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH"
     registry::Read "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH" .R0 .R1 .R2 .R3
  AddToPath_UserCont:
    StrCmp $R2 "" AddToPath_NTdoIt
    Push $R2 ; push the current PATH value onto the stack
...
;     WriteRegStr HKCU "Environment" "PATH" $0
      registry::Write "HKEY_CURRENT_USER\Environment" "PATH" "$0" "$R3" .R0
...
;     WriteRegStr HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH" $0
      registry::Write "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH" "$0" "$R3" .R0
...
;   ReadRegStr $1 HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH"
  ...
  unRemoveFromPath_UserCont:
    Push $R2
    Push $0
    Call un.StrStr ; Find $0 in $R2
    Pop $0 ; pos of our dir
    IntCmp $0 -1 unRemoveFromPath_done
      ; else, it is in path
      StrCpy $3 $R2 $0 ; $3 now has the part of the path before our dir
...
;     WriteRegStr HKCU "Environment" "PATH" $3
      registry::Write "HKEY_CURRENT_USER\Environment" "PATH" "$3" "$R3" .R0
...
;      WriteRegStr HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH" $3
      registry::Write "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "PATH" "$3" "$R3" .R0

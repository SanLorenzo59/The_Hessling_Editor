...
PDCURSES_DEFINES=-DPDC_DLL_BUILD -DPDC_WIDE
CURSESDLLINNSIS=/DCURSESDLL
STATIC=N
!else
PDCURSES_LIB=pdcurses.lib
PDCURSES_DEFINES= -DPDC_WIDE
CURSESDLLINNSIS=
STATIC=Y
!endif
...
REXXTRANSBIN = c:\bin
PDCURSESBIN = c:\bin
INCGUI = -I$(PDCURSES_SRCDIR_WIN32A) -I$(PDCURSES_SRCDIR_WIN32A)\win32a -DCHTYPE_LONG=2
INCCONSOLE = -I$(PDCURSES_SRCDIR_WIN32) -DCHTYPE_LONG=1
